...
const Toast: React.FC<ToastProps> = ({
  ...
  useEffect(() => {
    ...
    return undefined;
  }, [autoClose, duration, isVisible, isClosing]);
  ...
  const handleMouseLeave = () => {
    if (autoClose && !timerRef.current && remainingTimeRef.current > 0) {
    ...
    >
      ...
      {showProgress && autoClose && (
        <div className="h-1 w-full bg-gray-200">
          <div
            className={`h-full ${progressStyles[type]} transition-all duration-linear ease-linear`}
